    ...
    return (
        <div className={`menu-app ${isModalOpen ? 'menu-app-modal' : ''}`}>
            ...
            <div className="menu-links">
                ...
                <Button label="Itinerario" text size="small" icon="pi pi-file" onClick={() => navigate('/itinerario')} />
                ...
                <Button label="Reportes" text size="small" icon="pi pi-list-check" onClick={() => navigate('/reportes')} />
            </div>
